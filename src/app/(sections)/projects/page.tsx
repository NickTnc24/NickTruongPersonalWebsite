...
function projectLinks(title: string,urlName: string, imgPath: string, description: string, techUsed: Array<String>){
    return(
        <div className="flex rounded-md dark:backdrop-brightness-200 backdrop-brightness-90 max-w-[75%] gap-1">
...
export default function Projects(){
    return (
        <div className="min-h-screen flex flex-col gap-10">
          ...
          <div className="flex flex-row gap-y-10 justify-center mx-10">

...
export default function HeaderComponent(){
    return(
        <>
            <div className="relative flex flex-row items-center justify-between top-0 z-10 w-full rounded-md sm:duration-300 bg-gradient-to-t from-transparent to-neutral-700">

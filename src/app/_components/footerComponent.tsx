...
export default function FooterComponent(){
    return(
        <>
            <div className="relative flex flex-wrap flex-row justify-around text-lg max-sm:text-sm primary-dynamic py-6 mt-10 rounded-md gap-y-5 sm:mx-7 sm:duration-300">

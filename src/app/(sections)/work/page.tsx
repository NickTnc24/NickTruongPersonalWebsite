...
function projectLinks(title: string,urlName: string, imgPath: string, description: string, techUsed: Array<String>){
    return(
        <div className="flex rounded-md bg-darkbackgroundshade dark:bg-lightbackgroundshade justify-center flex-wrap lg:flex-nowrap gap-2 min-w-[300px] max-w-[720px] shadow-xl">

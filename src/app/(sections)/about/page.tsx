  ...
  return (
    <>
      <div className="min-h-screen flex flex-col gap-20 pt-20 bg-dynamic text-dynamic">
        ...
        <div>{aboutMe("marathon", "/_art/marathon.jpg", "I ran a marathon that raised money to eradicate child slavery in Ghana. I ran this in 4 hours and 35 minutes in my sophomore year of college in the winter. I was inspired by David Goggins to start this. This run was the day before all of my final exams which was super unlucky timing.")}</div>

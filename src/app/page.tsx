...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      <Link href = "/" className="text-7xl py-5 mb-10">
          Nick Truong
      </Link>
      {/* <ImageSlider></ImageSlider> */}
      <div className="flex flex-wrap flex-row justify-center items-center gap-x-96 gap-y-32 w-4/5">
        <Image 
        ...
        />
        <div className="w-1/2 about-picture-description">
